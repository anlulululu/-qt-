...
public:
    ...
    void setupUi(QDialog *CAddStuInfoDialog)
    {
        if (CAddStuInfoDialog->objectName().isEmpty())
            CAddStuInfoDialog->setObjectName("CAddStuInfoDialog");
